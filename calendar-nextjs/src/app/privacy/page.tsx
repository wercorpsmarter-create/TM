            ...
            <div className="space-y-8 leading-relaxed">
                ...
                <section>
                    ...
                    <ul className="list-disc pl-5 mt-2 space-y-1">
                        ...
                        <li>**Payment Information:** Credit card information and billing address (processed securely by Stripe; we do not store raw credit card numbers).</li>
                        <li>**Usage Data:** Logs, device information, and information about how you use our service (tasks created, schedules, etc.).</li>
                    </ul>
                </section>
                ...
                <section>
                    ...
                    <ul className="list-disc pl-5 mt-2 space-y-1">
                        <li>**Service Providers:** We share data with trusted third-party service providers necessary for operation (e.g., Stripe for payments, Vercel for hosting, Google for authentication).</li>
                        <li>**Legal Compliance:** When required by law or necessary to cooperate with government agencies.</li>
                        <li>**Business Transfer:** In the event of a merger, acquisition, or sale of assets.</li>
                    </ul>
                </section>
