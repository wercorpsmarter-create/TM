...
export default function CalendarTab({ user, setUser, tasks, onSyncClick, onAddTask, onLogin, linkedAccounts = [], onAddLinkedAccount, externalPopupTrigger, isActive, onDeleteTask, onToggleTask, onUpdateTask, view, setView, globalWeatherData, weatherSettings }) {
    ...
    // Auto-close removed as per user request for persistent side pane
    ...
    return (
        <div style={{
            ...
            <div style={{ position: 'relative', display: 'flex', flex: 1, overflow: 'hidden', minHeight: 0 }}>
                ...
                <div style={{ padding: '0', flex: 1, display: 'flex', flexDirection: 'row', overflow: 'hidden', minHeight: 0, position: 'relative' }}>
                    ...
                    <div style={{ opacity: fadingIn ? 0 : 1, transition: 'opacity 0.2s ease', display: 'flex', height: '100%' }}>
